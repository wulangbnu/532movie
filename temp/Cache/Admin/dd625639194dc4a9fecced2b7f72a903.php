...
<div class="topnav">
  <div class="sitenav">
    <div class=welcome>你好：<span class="username"><?php echo $_SESSION["user"];?> </span>，欢迎登录532Movie管理中心</div>
    <div class=sitelink><a href="javascript:Mapshow();">功能地图</a> |<a href="?s=admin/index" target="_parent">后台首页</a> | <a href="./" target="_blank">网站主页</a>  | <a class="top-txt" href="?s=Admin/Cache/Del" target="frmright" id="delcache">更新缓存</a><a id="cache"></a></div>
  </div>
  <div class="leftnav">
    <ul>
      <li class="navleft"></li>
