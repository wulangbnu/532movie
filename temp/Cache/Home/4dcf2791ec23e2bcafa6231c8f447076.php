	...
	<div class="main_n">
		...
		<div class="list_r">
   		...
   		<div class="newscontent">
        	...
        	<h2><?php echo (get_color_date('Y-m-d H:i:s',$addtime)); ?>　来源: <?php echo (($reurl)?($reurl):'原创'); ?></h2>
        	<p><?php if(!empty($picurl)): ?><div class="pic"  align="center"> <img src="<?php echo (($picurl)?($picurl):''); ?>" onerror="this.src='<?php echo ($tplpath); ?>images/error_198_280.jpg'" alt="<?php echo ($title); ?>"/> </div><?php endif; ?>
            <?php echo ($content); ?></p>
            <div class="option_btn">
             <?php if(C(url_html) == 1): ?><div class="approve"><a href="javascript:void(0)" id="Up" class="Up"><span>顶</span>(<font id="UpNum"><?php echo ($up); ?></font>)</a></div>
<div class="rejector"><a href="javascript:void(0)"  id="Down" class="Down"><span>踩</span>(<font id="DownNum"><?php echo ($down); ?></font>)</a></div>
<?php else: ?>
<div class="approve"><a href="javascript:void(0)" id="Up"><span>顶</span>(<font id="UpNum"><?php echo ($up); ?></font>)</a></div>
<div class="rejector"><a href="javascript:void(0)"  id="Down"><span>踩</span>(<font id="DownNum"><?php echo ($down); ?></font>)</a></div><?php endif; ?>
