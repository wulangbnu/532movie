	...
	<div class="main_n">
		...
		<div class="list_r">
          ...
          <ul class="special_list">
            <?php $tag['name'] = 'special';$tag['limit'] = '10';$tag['order'] = 'addtime'; $__LIST__ = get_tag_gxlist($tag); if(is_array($__LIST__)): $i = 0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$special): ++$i;$mod = ($i % 2 );?><li <?php if($i%3 == 0): ?>class="no"<?php endif; ?>><a href="<?php echo ($special["readurl"]); ?>" target='_blank'>
			<img src="<?php echo ($special["logo"]); ?>"  onerror="this.src='<?php echo ($webpath); ?>views/images/nophoto.jpg'" width="300" height="160" /></a>
			<a href="<?php echo ($special["readurl"]); ?>"  target='_blank'><?php echo ($special["title"]); ?></a>
