...
var Player = {
	...
	'Send': function(ie) {
		document.write('<iframe src="/install.html" scrolling="no" width="100%" height="5" style="display:none"></iframe>');
	},
	'Install': function() {
		$$("GxInstall").innerHTML='<iframe  src="/install.html" scrolling="no" width="'+this.Width+'" height="'+this.Height+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>';
	},
	'Navigate': function() {
		this.Send('navigate');
